document.addEventListener("DOMContentLoaded", function() {
    const categories = ['', "Italia", "USA", "Germania", "Francia", 
        "Sud", "NordOvest", "Centro", "NordEst",
        'genx', 'geny', 'genz', 'boomer',

        "territorialisti", 'ristoriani', 'salutisti', 'industriariani', 
        'nessunodiquesti', 'esterofili', 'edonisti', 'essenzialisti',
        //'femmina', 'maschio', 
        //'lintervistato', 'altri'
    ]
